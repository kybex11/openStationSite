...
<div>
    ...
    <header>
    <h1 class="typing-small">Hello, This is OpenStation <button @click="navigateTo('/auth')" class="button button-primary"> Auth</button></h1>
    ...
    <div class="center-filter">
      ...
      <h1>This website made in Vite and Nuxt TS</h1>
  </header>
</div>
</template>
